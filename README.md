...
- 任务分域：每个管理模块各自保存主对象和任务，独立待办保存到 `todos/tasks.json`。
...
```text
ScholarData/
  overview/checkins.json
  projects/projects.json
  projects/tasks.json
  affairs/affairs.json
  affairs/tasks.json
  focus/focus_sessions.json
  focus/schedule_blocks.json
  thesis/thesis_infos.json
  thesis/tasks.json
  todos/tasks.json
  outcomes/submissions.json
  health/health_habits.json
  health/health_records.json
  mental/mental_care_records.json
  milestones/achievements.json
  settings/affairs.json
  settings/todos.json
